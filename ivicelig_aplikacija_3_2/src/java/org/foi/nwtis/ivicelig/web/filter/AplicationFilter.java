...
public class AplicationFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AplicationFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AplicationFilter:DoAfterProcessing");
        }
   ...
   public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (!daliSesijaPostoji) {
            if ( url.endsWith("pregledJMSmqtt.xhtml")||url.endsWith("pregledStanja.xhtml")) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AplicationFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AplicationFilter()");
        }
        StringBuffer sb = new StringBuffer("AplicationFilter(");
